...
\input{Trabajo-Final-concordance}
...
Asume que la distribuci\'on uniforme de muertes sigue una distribuci\'on uniforme en cada a\~no, su abreviaci\'on es UDD (Uniform distribution of deaths). Puede ser visto como una regresi\'on lineal. \\
...
aplicandolo a la ecuaci\'on \ref{eqn:ecRegresionLineal} tendriamos
